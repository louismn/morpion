...
def game_status
			...
			if ($all_cases[0].is_x && $all_cases[1].is_x && $all_cases[2].is_x || $all_cases[3].is_x && $all_cases[4].is_x && $all_cases[5].is_x || $all_cases[6].is_x && $all_cases[7].is_x && $all_cases[8].is_x || $all_cases[0].is_x && $all_cases[3].is_x && $all_cases[9].is_x || $all_cases[2].is_x && $all_cases[4].is_x && $all_cases[6].is_x || $all_cases[0].is_x && $all_cases[3].is_x && $all_cases[6].is_x || $all_cases[1].is_x && $all_cases[4].is_x && $all_cases[7].is_x || $all_cases[2].is_x && $all_cases[5].is_x && $all_cases[8].is_x)
				self.victory 
				@winner = $player1
...
case_1,case_2,case_3,case_4,case_5,case_6,case_7,case_8,case_9 = Boardcase.new(1), Boardcase.new(2), Boardcase.new(3), Boardcase.new(4), Boardcase.new(5), Boardcase.new(6), Boardcase.new(7), Boardcase.new(8), Boardcase.new(9)
